...
@section('content')
 <div class="card text-white bg-primary shadow">
    ...
    top: 6px;">
            ...
            <a href="{{route('vehicles.create')}}" class="btn btn-light"  style="float: left;margin-right:10px;" >
        ...
        <div class="card-body" style="background-color: white;color:#31353D">
            ...
            <div class="data-table">
                @include('dashboard.vehicles.table')
        ...
        <div class="modal fade" id="edit{{$vehicle->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" method="post" action="{{route('vehicles.update',$vehicle->id)}}" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('put') }}
    ...
    <script>
        ...
        $(':button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '/dashboard/vehicles/vehicleChangeStatus',
