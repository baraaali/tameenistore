...
<div class="card text-white bg-primary shadow">
	...
	إضافة مركبة
		...
		<a href="{{route('vehicles.index')}}" class="btn btn-light"  style="float: left" >
...
@section('js')
    <script>
        ...
        {
            $('.new-vehicle').find('.preview').attr('src','')
            $('.new-vehicle').find('.preview').hide()
            $('.new-vehicle').find('[name="en_name[]"]').val('')
            $('.new-vehicle').find('[name="ar_name[]"]').val('')
            $('.new-vehicle').find('[name="image[]"]').val('')
        }
