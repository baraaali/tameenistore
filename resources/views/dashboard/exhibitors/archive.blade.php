...
<div class="card text-white bg-primary shadow">
    ...
    top: 6px;">
		...
		<a href="{{route('exhibitors')}}"  class="btn btn-light"  style="float: left" >
			...
			<tbody >
				@foreach($exhibitors as $key=>$exhibitor)
					<tr>
						...
						<td>
							<a href="{{url('/')}}/dashboard/exhibitors/restore/{{$exhibitor->id}}" class="btn btn-primary btn-xs">
								<i class="fa fa-redo"></i> إسترجاع
							</a>
							<a href="{{url('/')}}/dashboard/exhibitors/force/{{$exhibitor->id}}" class="btn btn-danger">
