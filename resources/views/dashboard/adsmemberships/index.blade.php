...
{{--                            </a>--}}
                            <a class=" btn btn-danger" onclick="return confirm('Are you sure?')" href="{{ route('ads-memberships.destroy', $price->id)}}">
    ...
    <div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form" method="post" action="{{route('ads-memberships.store')}}">
                    @csrf
        ...
        <div class="modal fade" id="edit{{$price->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="tdocument">
                <div class="modal-content">
                    ...
                    <form class="form" method="post" action="{{route('ads-memberships.update',$price->id)}}">
                        @csrf
                        {{ method_field('put') }}
