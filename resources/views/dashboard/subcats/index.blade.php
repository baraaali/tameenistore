...
@section('content')
@php
   $categories=App\Cat::where('status',1)->get();
@endphp
<div class="card text-white bg-primary shadow">
    ...
    top: 6px;">
		...
		<a href="{{route('sub_cats-archive')}}"  class="btn btn-light"  style="float: left" >
            ...
            <td>
                ...
                <input type="hidden" id="statusVal" class="statusVal_{{$cat->id}}" value="{{$cat->status}}">
						...
						<td>
							...
							<a href="{{route('sub_cats-delete',$cat->id)}}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-xs">
...
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form" method="post" action="{{route('sub_cats-store')}}" enctype="multipart/form-data">
      	@csrf
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <select name="cat_id" id="" class="SpecificInput">
...
<div class="modal fade" id="edit{{$cat->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form" method="post" action="{{route('sub_cats-update')}}" enctype="multipart/form-data">
      	@csrf
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <select name="cat_id" id="" class="SpecificInput">
            @foreach($categories as $category)
            <option value="{{$category->id}}" @if($category->id==$cat->cat_id)selected @endif>{{$category->name_ar}}</option>
            @endforeach
          </select>
        </div>
         <div class="form-group">
