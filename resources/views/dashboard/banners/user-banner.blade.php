                            ...
                            <table class="table table-stroped table-responsive ">
                               ...
                               @foreach($rows as $row)
                                    <tr>
                                        ...
                                        <td><span class="badge badge-info p-2 text-white">{{$row->active==0?'مفعل':'غير مفعل'}}</span></td>
                                                ...
                                                <div class="form-body">
                                                    <form method="POST" action="{{route('add-user-banner')}}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="link" class="SpecificInput" placeholder="https://www.your-domain.com">
                                                        </div>
    ...
    $(document).ready(function () {
        $('#banner').change(function () {
            ...
            if(item){
                $.ajax({
                    type:"GET",
                    url:"{{url('dashboard/user/banners/get-info')}}"+"/"+item+"/"+"{{$lang}}",
