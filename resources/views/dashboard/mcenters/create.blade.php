			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group">
						...
						<textarea name="ar_address" class="SpecificInput" rows="3" required="required"></textarea>
					</div>
				...
				<div class="col-md-5">
					...
					<div class="form-group">
						...
						<textarea name="en_address" class="SpecificInput" rows="3" required="required"></textarea>
					</div>
					<div class="form-group">
						<label>
