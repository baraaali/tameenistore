<table class="table table-stroped table-responsive table-straped text-center ">
    ...
    @foreach($items as $key=>$item)
        <tr>
            ...
            <td>{{$item->visitors}}</td>
            <td>{{$item->end_ad_date}}</td>
            <td>
                {{-- <a href="{{route('dash.items.show')}}" class="btn btn-light circle" >
                ...
                <a onclick="return confirm('Are you sure?')" href="{{route('items-delete',$item->id)}}"
           ...
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <form action="{{route('renew_ads_member_from_balance')}}" method="post">
                       ...
                       <div class="form-group col-md-12">
                           <input type="submit"  class="SpecificInput btn btn-primary" value="{{__('site.renew')}}" >
                       </div>
        ...
        <div class="modal fade" id="renewRow{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{route('dashboard_renew_date_item')}}">
                            @csrf
