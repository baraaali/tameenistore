    ...
    <div class="card text-white bg-primary shadow">
        ...
        <div class="card-header mt-3">
            <h5 style="position: relative; display: inline-block;top: 6px;">
                {{__('site.equipment for rent')}} 
            </h5>
           <a href="{{route('Ads-create',['lang'=>$lang])}}" class="btn btn-light"  style="float: left;margin-right:10px;" >
        ...
        <div class="card-body" style="background-color: white;color:#31353D">
            ...
            <div class="data-table">
                @include('dashboard.cars-rent.table',['items'=>$items])
            </div>
        </div>
    </div>
