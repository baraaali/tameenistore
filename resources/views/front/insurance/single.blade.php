...
<div class="container">
    <section>
        <ol class="breadcrumb bg-light">
            ...
            <li class="breadcrumb-item active">{{__('site.third Party Insurance')}}</li>
        </ol>
    ...
    <form method="get" action="{{route('dcFilter',$lang)}}" >
        ...
        <div class="form-row">
			...
			<div class="form-group col-md-2">
			    ...
			    <select class="SpecificInput typeofuseChange form-control" 
                value="@if(session()->has('type_of_use')){{session()->get('type_of_use')}}@endif"
                name="type_of_use" >

    			           <option @if(session()->get('type_of_use') == "private") selected @endif  value="private" >{{__('site.private')}}
    			           </option>
    			           <option @if(session()->get('type_of_use') == "rent") selected @endif  value="rent" > {{__('site.rent')}}</option>
    			       </select>
			</div>
            <div class=" form-group col-md-2">
                @if(app()->getLocale() == 'ar')
			...
			<div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        @if(app()->getLocale() == 'ar')
                    <label class=" w-100" style="display:block">
                    ...
                    <input type="hidden" name="year" value="{{$request_year}}">
                        <input type='text' name="price" value="{{$insurance_document->price}}" id="price_{{$insurance_document->id}}"  readonly class="SpecificInput borderless  w-100" style="margin-top: 10px;" >
                    </div>    
                    <div class="form-group col-md-3">
                     @if(app()->getLocale() == 'ar')
                    ...
                    @endif
                        <input type='text' value="{{$insurance_document->deliveryFee}}"  class="SpecificInput borderless w-100"  style="margin-top: 10px;" readonly >
                    </div>
                    ...
                    @endif
                        <input type='date' required  name="date"  class="SpecificInput  w-100 borderless"  style="margin-top: 10px;" multiple >
                    </div>
                    ...
                    @endif
                        <input type='file'  name="files[]" required  class="SpecificInput borderless  w-100"  style="margin-top: 10px;" multiple >
                    </div>
                </div>
                     {{--  insurance_durtaion --}}
                <div class="col-md-12">
                        <div class="row">
                             <div class="form-group col-md-6" style="text-align: center">
                                    @if(app()->getLocale() == 'ar')
                                     ...
                                     <small  class="text-danger">*</small>
                                        <button type="button" class="show btn btn-outline-primary " onclick="insurance_durtaion({{$now_year}},{{$request_year}},{{$insurance_document}})"  style="margin-top:10px;">حساب مده التامين</button>
                                    @else
                                         &nbsp;	&nbsp; <small  class="text-danger">*</small>
                                    </label>
                            ...
                            <div class="com-md-12">
                                <div class="row">
                                    <select class="select2 w-100" id="induration_{{$insurance_document->id}}" onchange="insurance_cost(this.id,{{$insurance_document->price}})" name="inDuration" style="margin-top:10px;">
