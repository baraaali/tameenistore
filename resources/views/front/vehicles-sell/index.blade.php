...
<!-- end banner -->
 <div class="container">
     <section class="mb-4">
         <h1> {{$vehicle ? $vehicle->getName() : __('site.vehicles')}}    <span>{{__('site.for sell')}}</span> </h1>
     </section>
     <section>
        <div class="col-lg-12">
     ...
     <section class="mt-4">
           <div class="col-md-12 loading  d-none">
            ...
            <div class="col-lg-12 ads">
                 @include('front.vehicles-sell.items',$cars)   
            </div>
...
<script>
    ...
    var setLike = function()
    {
        $('.like-action').on('click',function(){
            window.setLike($(this),'vehicles_sell')
     })
    }
