                        ...
                        <ul class="list-unstyled p-0 m-0">
                            <li class="border-bottom p-3">
                             ...
                             <li class="border-bottom p-3">
                                ...
                                <span class="badge badge-info text-white p-1 m-1">{{__('site.'.$arr[$car->rent_type])}}</span>
                     ...
                     <div class="w-100">
                        <div class="row m-0 ">
                            <div class="col-md-6 p-0 m-0">
                                <a  href="https://wa.me/{{$car->user->phones}}"  data-toggle="tooltip" title="دردشة عن طريق الواتساب"   style="height: 60px;line-height:40px" class="btn border my-1 w-100 bg-white" >  <strong> <i class="fab  fa-whatsapp-square text-success mx-1" ></i> {{__('site.whatsApp')}}  </strong></a>
                            </div>
                            <div class="col-md-6 p-0 m-0">
                                <a   href="tel:{{$car->user->phones}}" data-toggle="tooltip"   title="الإتصال بصاحب الإعلان"  style="height: 60px;line-height:40px" class="btn border my-1 w-100 bg-white"  > <strong> <i class="fa fa-phone text-success mx-1" aria-hidden="true"></i> {{__('site.phone number')}}  </strong></a>
                            </div>
                        ...
                        <div class="mt-3 p-0">
                            <button style="height:60px" type="button" class="btn btn-primary w-100" data-toggle="modal" data-target="#rent-request-modal">
