        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-12" style="padding-top: 30px;">
                    <div class="col-lg-12">
                        <form action="{{route('search_cars_rent',$lang)}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-weight: 600">{{__('site.rent_type')}}</label>
                                    <select name="car_type" class="col-lg-12 cond-ajax sty_select select2">
                                        <option selected >{{(__('site.select_rent_type'))}}</option>
                                        <option value="1">{{__('site.daily')}}  </option>
                                        <option value="2">{{__('site.weekly')}}  </option>
                                        <option value="3">{{__('site.monthly')}} </option>
                                        <option value="4">{{__('site.rent_for_have')}} </option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                       ...
                                       <p class="card-hint-line">
			                            <span class="hint-line">
			                               ...
			                               @if(app()->getLocale() == 'ar')
                                            ...
                                            <p class="card-title">
                                                ...
                                                <span class="text-primary text-left mr-5 btn btn-warning" style="font-size: 12px;">
                                                    @if($car->rent_type==1){{__('site.daily')}}
                                                    @elseif($car->rent_type==2){{__('site.weekly')}}
                                                    @elseif($car->rent_type==3){{__('site.monthly')}}
                                                    @elseif($car->rent_type==4){{__('site.rent_for_have')}}
                                        ...
                                        <span class="second-detail margin-right">
			                                <i class="far fa-clock"></i>
                                               {{Carbon::parse($car->end_ad_date)->toFormattedDateString()}}
			                            </span>
                                            </p>
