...
@section('content')
    ...
    <div class="container" dir="{{$lang=='ar'?'rtl':'ltr'}}">
            ...
            <div class="card PageCard">
                <div class="card-body" style="padding:0px;">
                    ...
                    <h6 class="text-muted desc-textpg"><span
                            style="font-weight:bold;">{{__('site.are_u_have_agency')}} </span> {{__('site.u_can_do')}}
                    </h6>
                    <div class="clr"></div>
                                ...
                                <div class="row pt-4">
                                    <div class="colum col-sm-2">
                                        <select class="custom-select " name="category">
                                            ...
                                            @foreach(\App\Categories::where('status',1)->get() as $cat)
                                                <option
                                                    value="{{$cat->id}}"@if($_POST)@if($_POST['category'] == $cat->id) {{ 'selected' }} @endif @endif>
                                                    {{$cat->$name}} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="colum col-sm-2 ">
                                        <input type="number" name="start_price" class="btn btn-light SpecificInput"
                                               placeholder="{{__('site.start_price')}}"
                                               oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                    </div>
                                    <div class="colum col-sm-2 ">
                                        <input type="number" name="end_price" class="btn btn-light SpecificInput"
                                               placeholder="{{__('site.to_price')}}"
                                               oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                    </div>
                                    <div class="colum col-sm-2 ">
                                        <input type="text" name="name" class="btn btn-light SpecificInput"
                                               placeholder="{{__('site.by_name')}}">
                                    </div>
        ...
        <div class="row background_dep mt-4">
                    ...
                    <div class="card" style="padding:20px;height:400px;">
                        <div class="" style="height:150px">
                            ...
                            <div class="">
                                ...
                                <a data-fancybox="cats" href="{{url('/')}}/uploads/{{$item->main_image}}">
                                    <img src="{{url('/')}}/uploads/{{$item->main_image}}" alt="" class="img-thumbnail"
                        ...
                        <p class="card-hint-line" style="">
                            ...
                            <span class="second-detail">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                                <i class="fa fa-eye"></i>  {{$item->visitors}}
                            </span>
                        </p>
                        <p class="card-title">
                        ...
                        <a href="{{route('showCat',['id'=>$item->id,'lang'=>$lang])}}">
                            <button class="btn btn-dark btn-block">
                                <i class="fas fa-eye"></i> {{__('site.show')}}
                            </button>
                        </a>
                    </div>
                </div>
