  ...
  <div class="col-lg-12">
      <div class="container">
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6">
                 <div class="row">
                      <div class="col-lg-4">
                         <img src="{{url('/')}}/uploads/{{$exhibitors->image}}" style="width:100%;height:100%">
                     </div>
                     <div class="col-lg-8">
                         <h5>
                              @if(app()->getLocale() == 'ar')
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-4" style="text-align:center;border-right:1px solid #d3d3d3">
                            ...
                            <p style="margin-top: 20px;font-weight: bold;">{{$exhibitors->country->ar_name}}</p>
                        </div>
                      
                        <div class="col-lg-4" style="text-align:center;border-right:1px solid #d3d3d3">
                            <i class="fas fa-building" style="font-size: 60px;color: #0674FD;"></i>
                            <p style="margin-top: 20px;font-weight: bold;">عدد الفروع : {{count($exhibitors->branchers)}}</p>
                        </div>
                        @else
                        <div class="col-lg-4" style="text-align:center;border-left:1px solid #d3d3d3">
                            <i class="fas fa-map-marker-alt" style="font-size: 60px;color: #0674FD;"></i>
                            <p style="margin-top: 20px;font-weight: bold;">{{$exhibitors->country->en_name}}</p>
                        </div>
                     
                        <div class="col-lg-4" style="text-align:center;border-left:1px solid #d3d3d3">
                            <i class="fas fa-building" style="font-size: 60px;color: #0674FD;"></i>
                            <p style="margin-top: 20px;font-weight: bold;">No.Of Branch : {{count($exhibitors->branchers)}}</p>
                        </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="col-lg-4" style="border-right:1px solid #d3d3d3;padding:10px;text-align:center">
            ...
            <p>{{$exhibitors->days_on}}</p>
            <p>{{$exhibitors->times_on}}</p>
            <hr>
            <h5 style="padding:10px;"># روابط التواصل</h5>
            <a href="{{$exhibitors->email}}"class="btn btn-primary" style="text-align:center;margin-top:10px;display:block">{{$exhibitors->email}}</a>
            <a href="{{$exhibitors->fb_page}}"class="btn btn-light" style="text-align:center;margin-top:5px;display:block"><i class="fab fa-facebook-square"></i> رابط فيسبوك </a>
            <a href="{{$exhibitors->twitter_page}}" class="btn btn-light" style="text-align:center;margin-top:5px;display:block"><i class="fab fa-twitter-square"></i> رابط تويتر</a>
            <a href="{{$exhibitors->instagram}}" class="btn btn-light" style="text-align:center;margin-top:5px;display:block"><i class="fab fa-instagram"></i> رابط انستجرام</a>
            <hr>
            <h5 style="padding:10px;"># الموقع علي الخريطة</h5>
            {!! $exhibitors->google_map !!}
        </div>
        @else
        <div class="col-lg-4" style="border-left:1px solid #d3d3d3;padding:10px;text-align:center">
            ...
            <a href="{{$exhibitors->email}}"class="btn btn-primary" style="text-align:center;margin-top:10px;display:block">{{$exhibitors->email}}</a>
            <a href="{{$exhibitors->fb_page}}"class="btn btn-light" style="text-align:center;margin-top:5px;display:block"><i class="fab fa-facebook-square"></i> Facebook Link</a>
            <a href="{{$exhibitors->twitter_page}}" class="btn btn-light" style="text-align:center;margin-top:5px;display:block"><i class="fab fa-twitter-square"></i> Twitter Link</a>
            <a href="{{$exhibitors->instagram}}" class="btn btn-light" style="text-align:center;margin-top:5px;display:block"><i class="fab fa-instagram"></i> Instagram Link</a>
            <hr>
