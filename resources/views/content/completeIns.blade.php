...
@section('content')
    ...
    <div class="col-lg-12 cover-adv"
         style="height: 250px;background-image:url({{url('/')}}/uploads/photo-1493238792000-8113da705763.jpg">
        <div class="upper">

            <h2 class="place" style="">
                {{__('site.price_comparison')}}
            </h2><br>
            <marquee style="font-family:Book Antiqua; color: #FFFFFF" scrollamount="6" loop="100" onmouseover="this.stop();" onmouseleave="this.start();" direction="right" height="100%">
                @foreach($marks as $mark)
                    <span class="text-danger mt-2 mark-font">
                        <!--<img src="{{url('/')}}/uploads/{{$mark->logo}}" class="img-thumbnail" style="width: 60px;height: 60px">-->
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>{{__('site.enjoy')}}
                                                        ...
                                                        <?php if ($min != null) {
                                                            ...
                                                            if ($cost < $min) {
                                                                if($complete_insuranc->fake_discount==1){
                                                                    ...
                                                                    $price_value=$complete_insuranc->fake_discount==0?$min:($min-$discount);}
                                                                echo '  <span class=" col-sm-2">الخصم  : <span class="btn btn-danger text-primary ">'.$discount.'</span></span>';
