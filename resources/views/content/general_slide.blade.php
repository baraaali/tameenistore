...
{{--                                    {{dd($i)}}--}}
                                    ...
                                    <div class="col-sm-3">
                                        <div class="col-item">
                                            <div class="photo">
                                                @if($i->Price->discount_percent>0 && $i->Price->discount_end_date>$day)
                                                    <span class="notify-badge mtop-20">{{$i->Price->discount_percent}}%</span>
                                                @endif
                                            ...
                                            <div class="badge-holder">
                                                <?php
                                                $row=\App\AdsMembership::where('id',$i->special)->first();
                                                ?>
                                    <span class="badge badge-danger badge-custom
                                  @if ($row->type==2)badge-spacial
                                  @elseif($row->type==1)badge-silver
                                  @elseif($row->type==0)badge-normal
                                        @else badge-golden
                                    @endif">
{{--                                        {{dd($i)}}--}}
                                        @if($row->type==2) {{__('site.special')}}
                                        @elseif($row->type==1){{__('site.silver')}}
                                        @elseif($row->type==0){{__('site.normel')}}
                                        @else{{__('site.golden')}}
                                        @endif
                                    </span>
                                            </div>
                                            <div class="info">
                                                <div class="row">
                                                    <div class="price col-md-6">
                                                        ...
                                                        <h5 class="price-text-color">{{$i->Price->cost}} {{$i->Price->currency}}</h5>
...
{{--                                            <i class="far fa-clock"></i>  {{dd()}}--}}
                                            <i class="far fa-clock"></i>  {{Carbon::parse($i->end_ad_date)->toFormattedDateString()}}
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 text-center p-all third-detail-holder">
                                                                <div class="background-grey">
                                                                    ...
                                                                    <span class="third-detail SecondColor">{{$i->kilo_meters}}
                                                                        {{__('site.km')}}
                                                        </span>
                                                                </div>
                                                            </div>
                                                            <div class="col-4 text-center p-all third-detail-holder">
                                                                <div class="background-grey">
                                                                    ...
                                                                    <span class="third-detail SecondColor">{{$i->year}}</span>
                                                                </div>
                                                    ...
                                                    @if($i->OwnerInformation->agent)
                                                                        {{$i->OwnerInformation->agent->$name}}
                                                                    @elseif($i->OwnerInformation->exhibitor)
                                                                        {{$i->OwnerInformation->exhibitor->$name}}
                                                                    @else
                                                                        {{$i->OwnerInformation->User->name}}
                                                                    @endif
                                                </span>
                                                            </div>
