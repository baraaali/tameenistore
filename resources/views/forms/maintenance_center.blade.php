<div class="row">
    <div class="col-md-5">
        ...
        <div class="form-group">
            ...
            <input type="text" required="required" name="ar_name"  value="{{old('ar_name')}}" maxlength="191" class="SpecificInput">
        </div>
        <div class="form-group">
            <label>
                 أرقام الهاتف
            </label>
            <input type="text" name="phones"  value="{{old('phones')}}" placeholder="0xxxxx-0xxxxxx-0xxxxxx-0xxxxxx"  class="SpecificInput">
        </div>
        <div class="form-group">
            <label>
                عنوان المركز بالعربية <small class="text-danger">*</small>
            </label>
            <textarea name="ar_address"  value="{{old('ar_address')}}" class="SpecificInput" rows="3" required="required"></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="file" name="image"  value="{{old('image')}}"  class="SpecificInput" required="required">
        </div>

        <div class="form-group">
             وصف بالعربي <small class="text-danger">*</small>
          <textarea required class="form-control" name="ar_description" rows="3"></textarea>
        </div>
        <div class="form-group">
            وصف بالأنجليزي <small class="text-danger">*</small>
         <textarea required class="form-control" name="en_description" rows="3"></textarea>
       </div>
    ...
    <div class="col-md-5">
        ...
        <div class="form-group">
            ...
            <input type="text" required="required" value="{{old('en_name')}}"  name="en_name" maxlength="191" class="SpecificInput">
        </div>
        <div class="form-group">
            <label>
                عنوان المركز   بالانجليزية <small class="text-danger">*</small>
            </label>
            <textarea name="en_address"  value="{{old('en_address')}}" class="SpecificInput" rows="3" required="required"></textarea>
        </div>
        <div class="form-group">
            <label>
        ...
        <div class="form-group">
            ...
            <button type="button" class="btn btn-primary w-100 d-block" data-toggle="modal" data-target="#modal-services-field">
              ...
              <div class="div-services-field"></div>
        ...
        <div class="form-group">
            ...
            <select class="SpecificInput" name="status"  value="{{old('status')}}" >
